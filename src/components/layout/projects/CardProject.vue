  ...
  <div class="md:col-span-4 group">
    ...
    >
      ...
      <div class="p-8 flex-grow flex flex-col">
        <h3 class="font-headline-sm text-headline-sm text-on-surface mb-2">IA Dental</h3>
        <p class="font-body-md text-body-md text-on-surface-variant mb-6">
          Un sistema integral de gestión clínica para consultas dentales especializadas. Diseñado
          con un enfoque en visualización de datos de alta densidad y gráficos rápidos de pacientes.
        </p>
        <div class="mt-auto">
