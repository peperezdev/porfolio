  ...
  <section class="grid grid-cols-1 md:grid-cols-2 gap-2 mx-1 md:mx-0" id="experience">
    <div class="bento-card rounded-xl p-8 flex flex-col justify-between">
      <div>
        ...
        <p class="text-on-surface-variant text-body-md leading-relaxed mb-2 opacity-80">
          Creación de la interfaz visual y la interacción del usuario usando HTML, CSS, JavaScript y
          frameworks modernos.
        </p>
        <p class="text-on-surface-variant text-body-md leading-relaxed mb-2 opacity-80">
        ...
        <p class="text-on-surface-variant text-body-md leading-relaxed mb-8 opacity-80">
          Diseño, consulta y gestión de bases de datos tanto relacionales (SQL) como no relacionales
          (NoSQL).
        </p>
      </div>
    ...
    <div class="bento-card rounded-xl p-8 flex flex-col justify-between">
      <div>
        ...
        <p class="text-on-surface-variant text-body-md leading-relaxed mb-2 opacity-80">
          Manejo de grandes bases de datos y desarrollo de algoritmos de aprendizaje automático para
          la predicción y análisis de datos.
        </p>
        <p class="text-on-surface-variant text-body-md leading-relaxed mb-8 opacity-80">
          Desarrollo de modelos de IA para la predicción de tendencias y análisis de datos en tiempo
          real.
        </p>
      </div>
      <div class="flex flex-wrap gap-2">
