...
<template>
  ...
  <main class="pt-10 pb-25 px-margin-mobile md:px-margin-desktop max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter">
      <!-- Hero Image -->
      <div class="md:col-span-12 h-64 md:h-96 rounded-2xl overflow-hidden relative group">
        <img
      ...
      <div
        class="md:col-span-8 bg-surface-container-lowest border border-outline-variant/50 rounded-2xl p-lg shadow-sm"
      >
        ...
        <div
          class="bg-surface-container border border-outline-variant/20 rounded-xl p-md flex flex-col md:flex-row gap-4 items-center justify-center"
        >
          <div
          ...
          <div class="md:hidden material-symbols-outlined text-outline-variant rotate-90">
            trending_flat
          </div>
          <div
      ...
      <div
        class="md:col-span-12 bg-surface-container-lowest border border-outline-variant/50 rounded-2xl p-lg"
      >
        <div class="flex items-center gap-3 mb-6">
      ...
      <div
        class="md:col-span-12 bg-slate-900 rounded-2xl p-lg overflow-hidden border border-slate-800 shadow-xl"
      >
